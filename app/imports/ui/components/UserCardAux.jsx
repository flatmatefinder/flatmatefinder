...
const UserCardAux = ({ user, userData }) => (
  ...
  <Card style={{ width: '18rem', background: '#586266' }} className="landing-card">
    <Card.Img style={{ borderRadius: '50%', width: '220px', height: '220px', padding: '15px', display: 'block' }} src={user.pfp} alt="profile picture" className="mx-auto circular-portrait" />
    <Card.Body>
